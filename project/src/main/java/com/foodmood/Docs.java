...
public class Docs {
	...
	public static void display() {
		...
		window.getIcons().add(new Image(Docs.class.getResourceAsStream("/logo.png")));
		...
		ImageView github_icon = new ImageView(new Image(Docs.class.getResourceAsStream("/github.png")));
		...
		ImageView java_icon = new ImageView(new Image(Docs.class.getResourceAsStream("/java.png")));
